...
// src/tables.ts
var GearTable = sqliteTable("gear", {
...
var GearRelations = relations(GearTable, function({ many }) {
  return {
    components: many(ComponentsTable)
  };
});
var ComponentsTable = sqliteTable("components", {
  added: text("added").notNull(),
  brand: text("brand"),
  distance: real("distance"),
  gear_id: text("gear_id").notNull().references(function() {
    return GearTable.id;
  }),
  id: text("id").primaryKey(),
  model: text("string"),
...
var ComponentsRelations = relations(ComponentsTable, function({ one }) {
  return {
    gear: one(GearTable, {
...
var GearRegex = /gear\/([b0-9]+).meta.json/;
